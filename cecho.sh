...
# Link: https://bytefreaks.net/gnulinux/bash/cecho-a-function-to-print-using-different-colors-in-bash
...
cecho () {
    ...
    if [ "$newLine" = true ] ; then
        echo -e "${colors[$color]} $message\e[0m";
    else
        echo -en "${colors[$color]} $message\e[0m";
    fi
